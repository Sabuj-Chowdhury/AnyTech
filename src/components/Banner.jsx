...
const Banner = () => {
  return (
    <div className="bg-gradient-to-r from-blue-900 to-blue-500 ">
      <section className="relative container mx-auto w-full min-h-[700px] flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-16 bg-gradient-to-r from-blue-900 to-blue-500 overflow-hidden">
        {/* Background Waves */}
        <motion.img
